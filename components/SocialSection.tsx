...
export default function SocialSection() {
  ...
  return (
    <section id="social" className="min-h-screen relative w-full flex justify-center items-center px-8">
      <div className="max-w-7xl w-full py-20 relative z-10">
        ...
        >
          <h2 className="text-4xl font-bold text-white">My <span className="text-glow">Socials</span></h2>
        ...
        >
          {socials.map((social) => (
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
            >
              <div className="relative overflow-hidden rounded-2xl border border-zinc-800/50 p-8 transition-all duration-300 hover:border-zinc-700/50 bg-black/10 backdrop-blur-sm">
                <div className={`absolute inset-0 transition-all duration-500 ${social.bgColor} opacity-0 group-hover:opacity-10`}></div>
                ...
                <div className="relative z-10 flex flex-col items-center space-y-4">
                  <div className={`text-white transform transition-all duration-300 ${social.color} group-hover:scale-110 group-hover:-translate-y-1`}>
                    {social.icon}
                  </div>
                  <div className="text-center">
                  <h3 className={`text-xl font-semibold text-white transition-colors duration-300 ${social.color}`}>
                    {social.name}
                  </h3>
